...
def load_jax_weights(jax_path: str):
    ...
    with ocp.PyTreeCheckpointer() as ckptr:
        ...
        # Add this after line 222 in the load_jax_weights function
        import pprint
        print("Full checkpoint structure:")
        pprint.pprint(jax.tree_util.tree_map(lambda x: x.shape if hasattr(x, 'shape') else type(x), params))
    return params
